...
import { executeRoleSwap, executeReturn, RoleSwapError } from '@/lib/business/role-takeover'
...
export async function PATCH(request, { params }) {
  ...
  try {
    ...
    if (action === 'SEND') {
      ...
      return NextResponse.json({ error: 'Invalid action. Use SEND or RETURN' }, { status: 400 })
    }
  } catch (error) {
